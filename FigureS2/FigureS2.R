...
scoring_data <- read.csv("FigureS2_pathotypes.csv", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
...
phylo_tree <- read.tree(file = "Pca203_pruned_tree_for_FigS2.nwk")
...
dev.copy(pdf, "FigureS2.pdf", width = 8, height = 9)
dev.off()
