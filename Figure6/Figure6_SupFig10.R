...
## Figure S12 subset a
merged_intervals <- read.delim("all_intervals_figS10A.txt", sep = "\t", header = FALSE)
...
figS10_chr_sub <- subset(chrlen_melt, HAP %in% c("hap3","hap4","hap5","hap26","hap9","hap14"))

figureS10_revised$HAP <- factor(figureS10_revised$HAP, levels =c("hap3","hap4","hap5","hap26","hap9","hap14"))
figureS10_revised$REFHAP <- factor(figureS10_revised$REFHAP, levels =c("hap3","hap4","hap5","hap26","hap9","hap14"))
figureS10_revised$CHROM <- factor(figureS10_revised$CHROM, levels = c("chr1","chr2","chr3","chr4","chr5","chr6","chr7","chr8",
                                                                      "chr9","chr10","chr11","chr12","chr13","chr14","chr15","chr16","chr17","chr18"))
figS10_chr_sub$HAP <- factor(figS10_chr_sub$HAP, levels = c("hap3","hap4","hap5","hap26","hap9","hap14"))
...
ggsave("FigureS10A.tiff", plot3, device = "tiff", width = 7.5, height = 2.7, units = "in", dpi = 600)

## Figure S10B
merged_intervals <- read.delim("all_intervals_figS10B.txt", sep = "\t", header = FALSE)
...
figS10_chr_sub <- subset(chrlen_melt, HAP %in% c("hap1","hap2","hap10","hap11","hap12","hap13","hap15","hap16","hap17","hap18","hap19","hap20","hap6","hap23"))

figureS10_revised$HAP <- factor(figureS10_revised$HAP, levels =c("hap1","hap2","hap10","hap11","hap12","hap13","hap15","hap16","hap17","hap18","hap19","hap20","hap6","hap23"))
figureS10_revised$REFHAP <- factor(figureS10_revised$REFHAP, levels =c("hap1","hap2","hap10","hap11","hap12","hap13","hap15","hap16","hap17","hap18","hap19","hap20","hap6","hap23"))
...
figS10_chr_sub$HAP <- factor(figS10_chr_sub$HAP, levels = c("hap1","hap2","hap10","hap11","hap12","hap13","hap15","hap16","hap17","hap18","hap19","hap20","hap6","hap23"))
...
ggsave("FigureS10B.tiff", plot3, device = "tiff", width = 7.5, height = 5.5, units = "in", dpi = 600)
