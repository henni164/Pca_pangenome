...
fig5a_chr_sub <- subset(chrlen_melt, HAP %in% c("hap11","hap12","hap15","hap16","hap17","hap18"))

fig5a_sub <- subset(keepme, HAP %in% c("hap11","hap12","hap15","hap16","hap17","hap18"))
fig5a_sub <- subset(fig5a_sub, REFHAP %in% c("hap11","hap12","hap15","hap16","hap17","hap18"))
...
ggsave("Figure5_pangenome_blocks_100kb_panelb.tiff", plot2, device = "tiff", width = 7.5, height = 6, units = "in", dpi = 600)
...
final_joined <- full_join(merged_intervals, chrlen_melt, by = c("HAP","CHROM"))
final_joined$HAP <- factor(final_joined$HAP)
figures12_revised <- final_joined


figS12_chr_sub <- subset(chrlen_melt, HAP %in% c("hap3","hap4","hap5","hap26","hap9","hap14"))

figures12_revised$HAP <- factor(figures12_revised$HAP, levels =c("hap3","hap4","hap5","hap26","hap9","hap14"))
figures12_revised$REFHAP <- factor(figures12_revised$REFHAP, levels =c("hap3","hap4","hap5","hap26","hap9","hap14"))
figures12_revised$CHROM <- factor(figures12_revised$CHROM, levels = c("chr1","chr2","chr3","chr4","chr5","chr6","chr7","chr8","chr9","chr10","chr11","chr12","chr13","chr14","chr15","chr16","chr17","chr18"))
figS12_chr_sub$HAP <- factor(figS12_chr_sub$HAP, levels = c("hap3","hap4","hap5","hap26","hap9","hap14"))


figures12_revised <- figures12_revised[!is.na(figures12_revised$REFHAP),]
...
plot3 <- ggplot(data = figures12_revised, aes(y = HAP)) +
  ...
  ggchicklet:::geom_rrect(data = figS12_chr_sub, aes(xmax = len, fill = HAP), xmin = 1, ymin = 0, ymax = 1, r = unit(0.1, 'npc')) +
  geom_segment(aes(x = start, xend = end, color = REFHAP, group = HAP), y = 0.5, yend = 0.5, linewidth = 5.6, key_glyph = "pointrange") +
  ggchicklet:::geom_rrect(data= figS12_chr_sub, aes(xmax = len+50000), xmin = -49999, ymin = -0.01, ymax = 1.01, r = unit(0.1, 'npc'), color = "black", fill = NA, size = 0.3) +
  facet_grid(HAP ~ CHROM, labeller = labeller(CHROM = chr_labels), scales = "free_x", space = "free_x", switch = "y", margins = FALSE) +
  scale_x_continuous(expand = c(0.01,700000)) +
  scale_y_discrete(limits=rev, expand = c(0.01,0.01)) +
  scale_color_manual(breaks = c("hap3","hap4","hap5","hap26","hap9","hap14"),
                     values = c("#F45587","#FFA900","#0027D9","#6CAD00", "pink", "white"), 
                     name = "Color key", drop = TRUE, limits = c("hap3","hap4","hap5","hap26","hap9")) +
  scale_fill_manual(breaks = c("hap3","hap4","hap5","hap26","hap9","hap14"),
                    values = c("#F45587","#FFA900","#0027D9","#6CAD00","pink","white"), 
...
figS12_chr_sub <- subset(chrlen_melt, HAP %in% c("hap1","hap2","hap10","hap11","hap12","hap13","hap15","hap16","hap17","hap18","hap19","hap20","hap6","hap23"))

figures12_revised$HAP <- factor(figures12_revised$HAP, levels =c("hap1","hap2","hap10","hap11","hap12","hap13","hap15","hap16","hap17","hap18","hap19","hap20","hap6","hap23"))
figures12_revised$REFHAP <- factor(figures12_revised$REFHAP, levels =c("hap1","hap2","hap10","hap11","hap12","hap13","hap15","hap16","hap17","hap18","hap19","hap20","hap6","hap23"))
figures12_revised$CHROM <- factor(figures12_revised$CHROM, levels = c("chr1","chr2","chr3","chr4","chr5","chr6","chr7","chr8","chr9","chr10","chr11","chr12","chr13","chr14","chr15","chr16","chr17","chr18"))
figS12_chr_sub$HAP <- factor(figS12_chr_sub$HAP, levels = c("hap1","hap2","hap10","hap11","hap12","hap13","hap15","hap16","hap17","hap18","hap19","hap20","hap6","hap23"))
...
plot3 <- ggplot(data = figures12_revised, aes(y = HAP)) +
  ...
  scale_y_discrete(limits=rev, expand = c(0.01,0.01)) +
  scale_color_manual(breaks = c("hap1","hap2","hap10","hap11","hap12","hap13",
                                "hap15","hap16","hap17","hap18","hap19","hap20","hap6","hap23"),
                     values = c("#FF00F7","#00E095","black","#FFCD97", "#DDB8FF", "grey30", "#006023",
                                "#CFFFB8","#71E2ED","#AEB431","#6BA9B4","grey70","white","white","white"), 
                     name = "Color key", drop = TRUE, limits = c("hap1","hap2","hap10","hap11","hap12","hap13",
                                                                 "hap15","hap16","hap17","hap18","hap19")) +
  scale_fill_manual(breaks = c("hap1","hap2","hap10","hap11","hap12","hap13",
                               "hap15","hap16","hap17","hap18","hap19","hap20","hap6","hap23"),
                    values = c("#FF00F7","#00E095","black","#FFCD97", "#DDB8FF", "grey30", "#006023",
                               "#CFFFB8","#71E2ED","#AEB431","#6BA9B4","grey70","white","white","white"), 
                    name = "Color key", drop = TRUE, guide = "none") +
...
ggsave("Supplemental_figure12_pangenome_blocks_100kb_panelb.tiff", plot3, device = "tiff", width = 7.5, height = 5.5, units = "in", dpi = 600)
