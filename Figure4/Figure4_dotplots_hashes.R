...
ggsave("Figure4_a.tiff", combo_plot, device = "tiff", width = 7.5, height = 3, units = "in", dpi = 600)
...
ggsave("Figure_4b.tiff", aus_plot, device = "tiff", width = 7.5, height = 2, units = "in")
